...
object runMDM {
  ...
  val readConfig = ReadConfig(Map("uri" -> "mongodb+srv://:@bigdatainfoservice-0hd3l.mongodb.net/info_product.fichaproducto2?readPreference=primaryPreferred"))
  val writeConfig = WriteConfig(Map("uri" -> "mongodb+srv://:@bigdatainfoservice-0hd3l.mongodb.net/info_product.fichaproducto2"))
  //val readConfig = ReadConfig(Map("uri" -> "mongodb+srv://:0@bigdatainfoservice-8x89f.mongodb.net/info_product.fichaproducto?readPreference=primaryPreferred"))
  //val writeConfig = WriteConfig(Map("uri" -> "mongodb+srv://:@bigdatainfoservice-8x89f.mongodb.net/info_product.fichaproducto"))

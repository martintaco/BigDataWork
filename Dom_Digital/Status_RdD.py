...
try:
	...
	client.Object('belc-bigdata-domain-dlk-prd','dom-hana/Res_Status_Consultora/Status_'+ str(start_time.year)+str_month + str_day + '.txt').copy_from(CopySource='belc-bigdata-domain-dlk-prd/dom-hana/Res_Status_Consultora/Status_000')

	client.Object('belc-bigdata-domain-dlk-prd','dom-hana/Res_Status_Consultora/Status_000').delete()

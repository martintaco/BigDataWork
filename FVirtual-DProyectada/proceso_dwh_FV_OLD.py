...
def CalculaAnioCampana(anioCampana, delta):
	...
	#executor python3
	#python3 /home/belcorpuser/scripts/FVirtual-DProyectada/proceso_dwh_FV_OLD.py 10.12.6.95 5439 analitico awsbelcorp Belcorp2019 AKIAJK6A3CSH7NDH2TWA WenXCHfRDCitIqeXvGtG+2puDFXbzRN33W2Y/zfU FVirtual-DProyectada FVirtual-OLD.sql FaltanteProl_20190110.csv
...
stgTables = ['tmp_faltante_virtual']
...
for table in stgTables:
    try:		
        cursor.execute("copy lan_dm_analitico." + table + " from 's3://belc-bigdata-landing-dlk-prd/datalake/input/sap/FaltanteVirtual/" + filename + "' access_key_id '" + sys.argv[6] + "' secret_access_key '" + sys.argv[7] + "' ACCEPTANYDATE DATEFORMAT 'auto' ACCEPTINVCHARS IGNOREHEADER AS 1 delimiter ',' region 'us-east-1' escape;")

...
try:
	...
	client.Object('belc-bigdata-domain-dlk-prd','dom-hana/SemanaConsultora/CORP_'+ str(start_time.year)+str_month + str_day + '.txt').copy_from(CopySource='belc-bigdata-domain-dlk-prd/dom-hana/SemanaConsultora/CORP_000')

	client.Object('belc-bigdata-domain-dlk-prd','dom-hana/SemanaConsultora/CORP_000').delete()
